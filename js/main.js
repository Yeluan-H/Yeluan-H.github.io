...
require(['jquery'], function ($) {
	...
	settingsFn.prototype = {
		...
		apply: function () {
			...
			if (that.get('logo')) {
				...
				$(".logo").html('<img src="icon/logo.png"> <svg style="max-width:100px;max-height:100px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"></svg>');
			}
			// 夜间模式 和 壁纸
			var nightMode = {
				on: function () {
	...
	var bookMarkFn = function (ele, options) {
		this.$ele = $(ele);
		this.options = {
			data: [{ "name": "精选", "url": "choice()", "icon": "icon/discover.png" }, { "name": "热榜", "url": "https://tophub.today", "icon": "icon/tophub.png" }, { "name": "鲸吼", "url": "https://www.jinghooo.com", "icon": "icon/jinghou.png" }, { "name": "豆瓣", "url": "https://www.douban.com", "icon": "icon/douban.png" }, { "name": "易搜", "url": "https://yiso.fun", "icon": "icon/yisou.png" }, { "name": "迷客电影", "url": "https://www.mini4k.org", "icon": "icon/mike.png" }, { "name": "云盘资源", "url": "https://www.yunpanziyuan.xyz", "icon": "icon/yunpan.png" }, { "name": "吾爱破解", "url": "https://www.52pojie.cn", "icon": "icon/wuai.png" }, { "name": "果核剥壳", "url": "https://www.ghxi.com", "icon": "icon/guohe.png" }, { "name": "悠久宝库", "url": "https://u9baoku.xyz", "icon": "icon/youjiu.png" }],
		};
